...
def main(opt):
    ...
    log.save_csv_log_for_predict(opt, head, value, is_create=True)
...
def run_model(net_pred, optimizer=None, is_train=0, data_loader=None, epo=1, opt=None):
    ...
    for i, (p3d_h36) in tqdm(enumerate(data_loader)):
        ...
        p3d_out_all1,p3d_out_all2,p3d_out_all,weight = net_pred(p3d_src, input_n=in_n, output_n=10, itera=itera)
